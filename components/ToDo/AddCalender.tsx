...
export default function AddCalendar() {
  ...
  return (
    <Button
      ...
      className={`text-ui-sm my-4 ml-12 py-4 w-form-lg border border-gray-200 rounded-xl transition-colors ${session?.accessToken ? 'bg-secondary text-white hover:opacity-90' : 'bg-gray-200 text-gray-500'}`}
